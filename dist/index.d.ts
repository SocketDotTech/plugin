...
type onNetworkChange = (network: Network) => void;
type onTokenChange = (token: Currency) => void;
...
export { Bridge, BridgeName, Currency, Customize, FeeParams, Network, Route, TokenWithBalance, TxDetails, UserTx, WidgetProps, onNetworkChange, onTokenChange, transactionDetails };
